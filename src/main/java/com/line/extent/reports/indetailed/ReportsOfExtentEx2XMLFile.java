...
public class ReportsOfExtentEx2XMLFile {

	@Test
	public void extentTest() throws IOException {
		ExtentReports extent = new ExtentReports();
		ExtentSparkReporter spark = new ExtentSparkReporter("Sparkv5.html");
		
		final File CONF = new File("Configuration/spark-config.xml");
